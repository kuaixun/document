...
| moreLink | 更多跳转，可以为空，表示卡片的更多按钮具体跳转方式；url跳转方式时返回一个合法的http链接地址，app内部跳转时返回app://tab/coid的格式，tab和coid和数据项跳转定义一致，如app://1/4061表示跳转到新闻tab的热推频道，注意coid可以为空，表示跳转tab的默认首页 | String |
